...
typedef GPB_ENUM(BuddyListCmdID) {
  ...
  /** 新增枚举 0 */
  BuddyListCmdID_CidBuddyListUnknown = 0,
...
typedef GPB_ENUM(SwitchServiceCmdID) {
  ...
  /** 新增枚举 0 */
  SwitchServiceCmdID_CidSwitchUnknown = 0,
...
typedef GPB_ENUM(GroupModifyType) {
  ...
  /** 新增枚举 0 */
  GroupModifyType_GroupModifyTypeNone = 0,
...
typedef GPB_ENUM(TransferFileType) {
  ...
  /** 新增枚举 0 */
  TransferFileType_FileTypeNone = 0,
...
typedef GPB_ENUM(ClientFileRole) {
  ...
  /** 新增枚举 0 */
  ClientFileRole_ClientFileNone = 0,
